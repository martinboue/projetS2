...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 559.0, 495.0, 350.0, 208.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 236.5, 119.0, 205.0, 22.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "signal", "signal" ],
					"patching_rect" : [ 17.0, 119.0, 205.0, 22.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "signal", "signal" ],
					"patching_rect" : [ 236.5, 81.666664, 205.0, 22.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "signal", "signal" ],
					"patching_rect" : [ 11.0, 81.666664, 205.0, 22.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 864.333374, 257.0, 138.0, 22.0 ],
					"style" : "",
					"text" : "effetVideoMirroir.maxpat"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 276.0, 309.0, 126.0, 22.0 ],
					"style" : "",
					"text" : "AnalyseAudio.maxpat"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 144.0, 309.0, 126.0, 22.0 ],
					"style" : "",
					"text" : "AnalyseAudio.maxpat"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 11.0, 309.0, 126.0, 22.0 ],
					"style" : "",
					"text" : "AnalyseAudio.maxpat"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 130.666672, 183.0, 128.0, 22.0 ],
					"style" : "",
					"text" : "routeurAudio2.maxpat"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 783.0, 422.0, 120.0, 22.0 ],
					"style" : "",
...
, 			{
				"name" : "effetVideoNiveauDeGris.maxpat",
				"bootpath" : "~/Documents/gitkraken/projetS2/votreAppli/regieVideo/patchers",
				"type" : "JSON",
				"implicit" : 1
			}
